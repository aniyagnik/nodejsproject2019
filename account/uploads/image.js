...
addComment.click(()=>{
      ...
      if(value[0]=='@'){
        ...
        comments.append($(`<li style="font-family:'Segoe UI';font-size:1.5em;font-weight: 700;color:white;"><b>${viewinguser}</b> :<a href="/user/dashboard/search?searchUser=${name}">@${name}</a> ${value}</li>`))
      }
      else{
        name=false
