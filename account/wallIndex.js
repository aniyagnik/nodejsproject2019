...
app.get('/',(req,res)=>{
    ...
    if(req.user)
    {
        ...
        let isFriend=false,isreqSend=false,isDifferent=false
        ...
        .then(arr=>{    
            ...
            res.render('wall',{findinguser,userpic,imagesArr,wallpic,userWall,viewingUser,isFriend,isreqSend,isDifferent})
        })
    }
    else{res.redirect('/')}
})
