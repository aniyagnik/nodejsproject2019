...
client=new MongoClient('mongodb://test:nodeTest19@project-rtmdn.mongodb.net/test?retryWrites=true&w=majority' ||'mongodb://localhost:27017/project',{ useNewUrlParser: true })
client.connect()
